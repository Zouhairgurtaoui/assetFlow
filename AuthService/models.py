...
class UserSchema(ma.SQLAlchemyAutoSchema):
    ...
    firstname = ma.String(required=True, validate=lambda f: len(f) <= 50)
    lastname = ma.String(required=True, validate=lambda l: len(l) <= 50)
    email = ma.Email(required=True, validate=lambda e: len(e) <= 120)
